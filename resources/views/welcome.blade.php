...
<head>
    ...
    <link rel="apple-touch-icon" href="/icons/apple-touch-icon_norgb.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/icons/favicon-32_norgb.png">
    <link rel="icon" type="image/png" sizes="192x192" href="/icons/icon-192_norgb.png">
